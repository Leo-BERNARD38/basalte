...
export function basalteDoc(
  ...
  return [
    ...
    ...firstLogin(),
    '',
    '## Ce que ce site contient déjà',
    '',
    '```bash',
    'npx basalte content',
    '```',
    '',
    'Il relève les pages, les sections que chacune porte, l’avancement des',
    'traductions, les médias inemployés et la fiche d’entreprise. C’est par là',
    'qu’on commence, plutôt qu’en ouvrant les JSON de `content/` un par un.',
    '',
...
function commands(): readonly string[] {
  return [
    ...
    '— titre et description de page compris —, une traduction manquante dans',
    'une langue en ligne, une image sans texte alternatif ou absente du disque,',
    'et un format de contenu en retard, auquel cas il nomme `basalte migrate`.',
    'Il avertit sans refuser d’un titre repris d’une page à l’autre, d’une page',
    'qui se partage sans vignette et d’une fiche d’entreprise incomplète.',
    '',
