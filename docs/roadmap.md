...
|---|---|
| **L’en-tête et le pied cliquables dans l’aperçu** — on désigne une section en cliquant dessus (D219), mais pas les deux emplacements du chrome : `Layout.astro` les rend hors de l’enveloppe `[data-section]`, et l’aperçu montre alors l’accueil, dont les sections appartiennent à une autre entrée | Le premier client qui cherche l’en-tête dans l’aperçu au lieu du menu des pages. Les envelopper demande un drapeau sur `Layout.astro`, partagé avec le site construit, et une règle qui dise quand ils répondent — sur l’entrée du chrome, jamais sur une page, sans quoi le clic changerait de brouillon sans le dire |
| **La médiathèque tenue à l’écran**, comme la boîte des messages : sa grille et son panneau défilent aujourd’hui avec la page | Le premier site dont la médiathèque passe la cinquantaine d’images. Une galerie est une page qu’on parcourt, et le panneau vient déjà en vue quand on choisit une vignette : la carte à hauteur fixe (D221) n’y gagnerait que la moitié de ce qu’elle gagne sur une boîte |
